...
#define REF_SEN_L	950				//マウスを迷路中央に置いた時のセンサの値
#define REF_SEN_FR	3770				//マウスを迷路中央に置いた時のセンサの値
#define REF_SEN_FL	3770				//マウスを迷路中央に置いた時のセンサの値

#define TH_SEN_R	190				//壁があるか否かの閾値	車体を区画の左へ寄せた時のセンサ値(壁あり)
#define TH_SEN_L	90				//壁があるか否かの閾値	車体を区画の右へ寄せた時のセンサ値(壁あり)
#define TH_SEN_FR	30				//壁があるか否かの閾値	
#define TH_SEN_FL	30				//壁があるか否かの閾値
...
#define CON_FWALL_KP	(10.0)				//壁センサによる姿勢制御の比例制御の比例定数
...
#define OMEGA_KI	(0.3)				//Iゲイン
#define OMEGA_KD	(2.0)				//Dゲイン
